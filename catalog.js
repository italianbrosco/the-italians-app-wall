window.APP_CATALOG = [
  ...
  },
  {
    ...
    screenshot: "/assets/screenshots/marbles-build6.webp",
    screenshotAlt: "Marbles showing a polished wooden cross board, diagonal marble bases, player panels, a vertical two-dice control, chat, emotes, and undo",
    status: "coming",
    statusLabel: "Coming soon",
    accent: "amber",
    platforms: [],
  ...
  },
  {
    ...
    screenshot: "/assets/screenshots/get-in-line-build-8.png",
    screenshotAlt: "Get In Line Stats screen with personal runs and live global community totals",
    status: "coming",
    statusLabel: "Coming soon",
    accent: "purple",
    platforms: [],
