window.APP_CATALOG = [
  ...
  },
  {
    ...
    screenshotVersion: "20260824.1",
    screenshotAlt: "CalcSpace calculator chooser with everyday, scientific, conversion, and planning tools",
    status: "available",
  ...
  },
  {
    ...
    screenshotVersion: "20260824.1",
    screenshotAlt: "Mortgage Calculator Suite home screen with estimate shortcuts and recent estimates",
    status: "available",
    statusLabel: "Available now",
    accent: "olive",
    platforms: [{ label: "iPhone & iPad", kind: "ios" }],
  ...
  },
  {
    ...
    screenshotVersion: "20260824.1",
    screenshotAlt: "Deal Analyzer Suite new-deal screen with six real-estate strategies",
    status: "coming",
    statusLabel: "Coming soon",
    accent: "forest",
    platforms: [],
  ...
  },
  {
    ...
    screenshotVersion: "20260824.1",
    screenshotAlt: "Dream Journal home screen with the write-a-dream action and recent journal entries",
    status: "available",
    statusLabel: "Available now",
    accent: "lilac",
    platforms: [{ label: "iPhone & iPad", kind: "ios" }],
  ...
  },
  {
    ...
    name: "Blackwake 21",
    category: "Card game",
    description: "Play quick rounds of blackjack against a sharp-eyed pirate dealer in a storm-lit gaming hold.",
    icon: "/assets/icons/blackwake-21.webp",
    screenshot: "/assets/screenshots/blackwake-21.jpg",
    screenshotAlt: "Blackwake 21 pixel-art pirate blackjack table with dealer, player cards, totals, and hit, stand, and double actions",
    status: "coming",
    statusLabel: "Coming soon",
    accent: "rose",
    platforms: [],
  ...
  },
  {
    ...
    screenshot: "/assets/screenshots/get-in-line-build-9.png",
    screenshotAlt: "Get In Line community insights with most played, consensus, divisive, replayed, landslide, and closest-call questions",
    status: "coming",
    statusLabel: "Coming soon",
    accent: "purple",
    platforms: [],
