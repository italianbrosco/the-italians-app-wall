...
ssh "$REMOTE" "set -eu
  sudo install -d -m 755 '$TARGET' '$TARGET/.well-known' '$TARGET/assets' '$TARGET/assets/icons' '$TARGET/debug' '$TARGET/debug/apps' '$TARGET/abc-smash' '$TARGET/are-you-human' '$TARGET/blackwake-21' '$TARGET/clay-scorecard' '$TARGET/dont-touch-red' '$TARGET/road-trip-arcade' '$TARGET/tin-wings' '$TARGET/underworld-21' '$TARGET/dealanalyzer' '$BACKUP_ROOT/$STAMP'
  ...
  sudo chmod -R a+rX '$TARGET/.well-known' '$TARGET/assets' '$TARGET/debug' '$TARGET/abc-smash' '$TARGET/are-you-human' '$TARGET/blackwake-21' '$TARGET/clay-scorecard' '$TARGET/dont-touch-red' '$TARGET/road-trip-arcade' '$TARGET/tin-wings' '$TARGET/underworld-21' '$TARGET/dealanalyzer'
"
