...
rsync -az \
  ...
  .well-known assets debug are-you-human clay-scorecard road-trip-arcade tin-wings underworld-21 dealanalyzer \
  "$REMOTE:$REMOTE_STAGE/"

ssh "$REMOTE" "set -eu
  sudo install -d -m 755 '$TARGET' '$TARGET/.well-known' '$TARGET/assets' '$TARGET/assets/icons' '$TARGET/debug' '$TARGET/debug/apps' '$TARGET/are-you-human' '$TARGET/clay-scorecard' '$TARGET/road-trip-arcade' '$TARGET/tin-wings' '$TARGET/underworld-21' '$TARGET/dealanalyzer' '$BACKUP_ROOT/$STAMP'
  ...
  sudo chmod -R a+rX '$TARGET/.well-known' '$TARGET/assets' '$TARGET/debug' '$TARGET/are-you-human' '$TARGET/clay-scorecard' '$TARGET/road-trip-arcade' '$TARGET/tin-wings' '$TARGET/underworld-21' '$TARGET/dealanalyzer'
"
