...
rsync -az \
  ...
  .well-known assets debug clay-scorecard road-trip-arcade tin-wings dealanalyzer \
  "$REMOTE:$REMOTE_STAGE/"

ssh "$REMOTE" "set -eu
  sudo install -d -m 755 '$TARGET' '$TARGET/.well-known' '$TARGET/assets' '$TARGET/assets/icons' '$TARGET/debug' '$TARGET/debug/apps' '$TARGET/clay-scorecard' '$TARGET/road-trip-arcade' '$TARGET/tin-wings' '$TARGET/dealanalyzer' '$BACKUP_ROOT/$STAMP'
  ...
  sudo chmod -R a+rX '$TARGET/.well-known' '$TARGET/assets' '$TARGET/debug' '$TARGET/clay-scorecard' '$TARGET/road-trip-arcade' '$TARGET/tin-wings' '$TARGET/dealanalyzer'
"
