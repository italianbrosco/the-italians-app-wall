...
rsync -az \
  ...
  .well-known assets debug abc-smash are-you-human blackwake-21 clay-scorecard dont-touch-red marbles pt-airman real-or-ai road-trip-arcade tin-wings underworld-21 dealanalyzer yawtzee \
  "$REMOTE:$REMOTE_STAGE/"

ssh "$REMOTE" "set -eu
  sudo install -d -m 755 '$TARGET' '$TARGET/.well-known' '$TARGET/assets' '$TARGET/assets/icons' '$TARGET/debug' '$TARGET/debug/apps' '$TARGET/abc-smash' '$TARGET/are-you-human' '$TARGET/blackwake-21' '$TARGET/clay-scorecard' '$TARGET/dont-touch-red' '$TARGET/marbles' '$TARGET/pt-airman' '$TARGET/real-or-ai' '$TARGET/road-trip-arcade' '$TARGET/tin-wings' '$TARGET/underworld-21' '$TARGET/dealanalyzer' '$TARGET/yawtzee' '$BACKUP_ROOT/$STAMP'
  ...
  sudo chmod -R a+rX '$TARGET/.well-known' '$TARGET/assets' '$TARGET/debug' '$TARGET/abc-smash' '$TARGET/are-you-human' '$TARGET/blackwake-21' '$TARGET/clay-scorecard' '$TARGET/dont-touch-red' '$TARGET/marbles' '$TARGET/pt-airman' '$TARGET/real-or-ai' '$TARGET/road-trip-arcade' '$TARGET/tin-wings' '$TARGET/underworld-21' '$TARGET/dealanalyzer' '$TARGET/yawtzee'
"
