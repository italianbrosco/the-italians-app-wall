...
printf 'Verified %s: showcase, 24-app catalog including Ricochet, live legal pages, Deal Analyzer and Yawtzee universal/app links, and preserved /debug/apps page.\n' "$BASE_URL"
