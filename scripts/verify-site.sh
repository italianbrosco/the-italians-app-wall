...
grep -q 'app.js?v=20260825.2' "$TMP_DIR/home.html"
grep -q 'catalog.js?v=20260825.3' "$TMP_DIR/home.html"
grep -q '<strong data-total-count>25</strong>' "$TMP_DIR/home.html"
...
printf 'Verified %s: showcase, 25-app catalog including Draw Your Defense and Ricochet, live legal pages, Deal Analyzer and Yawtzee universal/app links, and preserved /debug/apps page.\n' "$BASE_URL"
