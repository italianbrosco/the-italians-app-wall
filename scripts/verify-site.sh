...
printf 'Verified %s: showcase, 22-app catalog including PT Airman, live legal pages, Deal Analyzer and Yawtzee universal/app links, and preserved /debug/apps page.\n' "$BASE_URL"
