...
grep -q 'catalog.js?v=20260824.2' "$TMP_DIR/home.html"
...
printf 'Verified %s: showcase, 23-app catalog including Embrace the Suck, live legal pages, Deal Analyzer and Yawtzee universal/app links, and preserved /debug/apps page.\n' "$BASE_URL"
