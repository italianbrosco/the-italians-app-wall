...
if (Array.isArray(catalog)) {
  ...
  const expected = { available: 3, coming: 23 };
  ...
  if (catalog.length !== 26) errors.push(`expected 26 apps, found ${catalog.length}`);
...
console.log("Catalog verified: 26 unique apps, 26 icons, 26 authentic screenshots, 3 store releases, 23 release updates coming soon, no testing links.");
